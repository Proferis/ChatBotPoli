...
const fs = require('fs');
const RESPONSES_SHEET_ID = '15Dy54k9Mm0Wl6TC5Pe9t6LSXvtaohplU53TxOSrvNko'; //Aquí pondras el ID de tu hoja de Sheets
...
const flowHola = addKeyword(['Hola','👋','🤚','👍','Buen dia','Buenas noches','Buenas tardes','hola','hey','hellow']).addAnswer('*Hola Vecino*, estas a unos pasos de formar parte de este grupo solidario, *responde a las siguientes preguntas*:')
.addAnswer(
'Dime tu sexo',
{capture:true,
buttons:
...
await flowDynamic ([{body:`Perfecto *${STATUS[telefono].nombre}*, gracias por unirte a este proyecto`}])
